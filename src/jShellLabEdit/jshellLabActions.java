 ...
 "11.   *.component  // last word is 'component'\n"
   ...
   weObj.displayExamples("Equation  Examples");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        jshellLabExec.jshellLab.ProcessPlottingSGTExamplesInJar   processPlottingInJar = new jshellLabExec.jshellLab.ProcessPlottingSGTExamplesInJar(gLabJarFile);
    }
   }
   class JShellLabSciWaveletExamplesAction extends AbstractAction {
       JShellLabSciWaveletExamplesAction() {
           super("JShellLabSci  Wavelet Examples");
       }

    public void actionPerformed(ActionEvent e) {
        String jLabJarFile = GlobalValues.jarFilePath;
        
        jshellLabExec.jshellLab.ProcessJShellLabSciWaveletsInJar  processJShellLabSciWaveletInJar = new jshellLabExec.jshellLab.ProcessJShellLabSciWaveletsInJar(jLabJarFile);
    }
   }
