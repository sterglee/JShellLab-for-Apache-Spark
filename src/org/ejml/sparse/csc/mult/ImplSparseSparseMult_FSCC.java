 ...
 * @author Peter Abeles
 */
public class ImplSparseSparseMult_FSCC {
                              ...
                              IGrowArray gw,   FGrowArray gx )
    {
        ...
        for (int bj = 1; bj <= B.numCols; bj++) {
            ...
            for (int bi = idx0; bi < idx1; bi++) {
                ...
                float valB = B.nz_values[bi];  // B(k,j)  k=rowB j=colB
    ...
    public static void multTransB(FMatrixSparseCSC A, FMatrixSparseCSC B, FMatrixSparseCSC C,
        ...
        else if( !CommonOps_FSCC.checkIndicesSorted(B)) {
     ...
     */
    public static void multAddColA(FMatrixSparseCSC A , int colA ,
                                   float alpha,
                                   FMatrixSparseCSC C, int mark,
                                   float x[] , int w[] ) {
        int idxA0 = A.col_idx[colA];
        int idxA1 = A.col_idx[colA+1];
     ...
     */
    public static void addRowsInAInToC(FMatrixSparseCSC A , int colA ,
                                       FMatrixSparseCSC C, int colC,
                                       int w[] ) {
        int idxA0 = A.col_idx[colA];
        int idxA1 = A.col_idx[colA+1];
