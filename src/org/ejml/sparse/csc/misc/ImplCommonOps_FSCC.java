...
import static org.ejml.sparse.csc.mult.ImplSparseSparseMult_FSCC.multAddColA;
...
public class ImplCommonOps_FSCC {
     ...
     */
    public static void transpose(FMatrixSparseCSC A , FMatrixSparseCSC C ,   IGrowArray gw ) {
    ...
    public static void addColAppend(float alpha, FMatrixSparseCSC A, int colA, float beta, FMatrixSparseCSC B, int colB,
                                    FMatrixSparseCSC C,   IGrowArray gw)
    {
