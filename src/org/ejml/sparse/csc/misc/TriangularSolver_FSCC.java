...
public class TriangularSolver_FSCC {
     ...
     */
    public static void solveTran(FMatrixSparseCSC G, boolean lower,
                                 FMatrixSparseCSC B, FMatrixSparseCSC X,
                                   int pinv[] ,
                                   FGrowArray g_x,   IGrowArray g_xi,   IGrowArray g_w)
    {
    ...
    private static int solveTranColumn(FMatrixSparseCSC G, float[] x, int[] xi, int[] w,
     ...
     * @param g_w   (Optional) Storage for workspace.
     */
    public static void solve(FMatrixSparseCSC G, boolean lower,
                             FMatrixSparseCSC B, FMatrixSparseCSC X,
                               int pinv[] ,
                               FGrowArray g_x,   IGrowArray g_xi,   IGrowArray g_w)
    {
     ...
     *              See {@link #searchNzRowsInX(FMatrixSparseCSC, FMatrixSparseCSC, int, int[], int[], int[])}
     ...
     */
    public static int solveColB(FMatrixSparseCSC G, boolean lower,
                                FMatrixSparseCSC B, int colB, float x[],
     ...
     */
    public static int searchNzRowsInX(FMatrixSparseCSC G, FMatrixSparseCSC B, int colB, int pinv[],
                                      int xi[], int w[]) {
     ...
     */
    private static int searchNzRowsInX_DFS(int rowB , FMatrixSparseCSC G , int top , int pinv[], int xi[], int w[] )
    {
     ...
     */
    public static void eliminationTree(FMatrixSparseCSC A, boolean ata, int parent[],   IGrowArray gwork) {
        int m = A.numRows;
        int n = A.numCols;
