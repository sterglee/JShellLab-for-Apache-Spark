...
public class CommonOps_FSCC {
     ...
     */
    public static FMatrixSparseCSC transpose(FMatrixSparseCSC a ,   FMatrixSparseCSC a_t ,   IGrowArray gw ) {

        if( a_t == null ) {
            a_t = new FMatrixSparseCSC(a.numCols,a.numRows,a.nz_length);
        } else {
    ...
    public static void mult(FMatrixSparseCSC A , FMatrixSparseCSC B , FMatrixSparseCSC C ) {
                              ...
                              IGrowArray gw,   FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.mult(A,B,C, gw, gx);
    }

    public static void multTransA(FMatrixSparseCSC A , FMatrixSparseCSC B , FMatrixSparseCSC C ,
                                    IGrowArray gw,   FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.multTransA(A,B,C,gw,gx);
    }
     ...
     * @param gx (Optional) Storage for internal workspace.  Can be null.
     */
    public static void multTransB(FMatrixSparseCSC A , FMatrixSparseCSC B , FMatrixSparseCSC C ,
                                    IGrowArray gw,   FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.multTransB(A,B,C,gw,gx);
    }
     ...
     * @param C Dense Matrix
     */
    public static void multTransA(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj C )
    {
        if( A.numRows != B.numRows )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        C.reshape(A.numCols,B.numCols);
     ...
     */
    public static void multAddTransA(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj C )
    {
     ...
     * @param C Dense Matrix
     */
    public static void multTransB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj C )
    {
        if( A.numCols != B.numCols )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        C.reshape(A.numRows,B.numRows);
     ...
     */
    public static void multAddTransB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj C )
    {
     ...
     */
    public static void innerProductLower(FMatrixSparseCSC A , FMatrixSparseCSC B ,
                                           IGrowArray gw,   FGrowArray gx )
    {
     ...
     */
    public static void symmLowerToFull( FMatrixSparseCSC A , FMatrixSparseCSC B ,   IGrowArray gw )
    {
                             ...
                             IGrowArray gw,   FGrowArray gx)
    {
        ...
        ImplCommonOps_FSCC.add(alpha,A,beta,B,C, gw, gx);
    }
     ...
     */
    public static void scale(float scalar, FMatrixSparseCSC A, FMatrixSparseCSC B) {
        if( A != B ) {
            B.copyStructure(A);
     ...
     * @param B (Output) Matrix. Modified.
     */
    public static void divide(FMatrixSparseCSC A , float scalar , FMatrixSparseCSC B ) {
        if( A != B ) {
            B.copyStructure(A);
     ...
     * @param B (Output) Matrix. Modified.
     */
    public static void divide( float scalar, FMatrixSparseCSC A , FMatrixSparseCSC B ) {
        if( A != B ) {
            B.copyStructure(A);
        }
        for (int i = 0; i < A.nz_length; i++) {
     ...
     * @param B (Output) Matrix. Modified.
     */
    public static void changeSign(FMatrixSparseCSC A , FMatrixSparseCSC B ) {
        if( A != B ) {
            B.copyStructure(A);
        }
    ...
    public static void elementMult( FMatrixSparseCSC A, FMatrixSparseCSC B, FMatrixSparseCSC C ,
        ...
        ImplCommonOps_FSCC.elementMult(A,B,C,gw,gx);
    }
     ...
     */
    public static FMatrixSparseCSC diag(   FMatrixSparseCSC A ,
     ...
     */
    public static void extractDiag(FMatrixSparseCSC src, FMatrixSparseCSC dst ) {
        int N = Math.min(src.numRows, src.numCols);

        if( !MatrixFeatures_FSCC.isVector(dst) ) {
            dst.reshape(N, 1, N);
     ...
     * @param dst A vector the results will be written into. Modified.
     */
    public static void extractDiag(FMatrixSparseCSC src, FMatrixRMaj dst ) {
        int N = Math.min(src.numRows, src.numCols);
     ...
     */
    public static FMatrixSparseCSC permutationMatrix(int[] p, boolean inverse, int N, FMatrixSparseCSC P) {
     ...
     * @param output (Output) Matrix which has the permutation stored in it.  Is reshaped.
     */
    public static void permute(  int permRowInv[], FMatrixSparseCSC input,   int permCol[], FMatrixSparseCSC output) {
     ...
     */
    public static FMatrixSparseCSC extractColumn(FMatrixSparseCSC A , int column ,   FMatrixSparseCSC out ) {
     ...
     */
    public static FMatrixSparseCSC extractRows(FMatrixSparseCSC A , int row0 , int row1 , FMatrixSparseCSC out ) {
...
//        out.nz_length = 0;
     ...
     */
    public static FMatrixRMaj sumCols(FMatrixSparseCSC input ,   FMatrixRMaj output ) {
        if( output == null ) {
     ...
     */
    public static FMatrixRMaj minCols(FMatrixSparseCSC input ,   FMatrixRMaj output ) {
        if( output == null ) {
            output = new FMatrixRMaj(1,input.numCols);
        } else {
            output.reshape(1,input.numCols);
     ...
     */
    public static FMatrixRMaj maxCols(FMatrixSparseCSC input ,   FMatrixRMaj output ) {
        if( output == null ) {
            output = new FMatrixRMaj(1,input.numCols);
        } else {
            output.reshape(1,input.numCols);
     ...
     */
    public static FMatrixRMaj sumRows(FMatrixSparseCSC input ,   FMatrixRMaj output ) {
        if( output == null ) {
     ...
     */
    public static FMatrixRMaj minRows(FMatrixSparseCSC input ,   FMatrixRMaj output ,   IGrowArray gw) {
        if( output == null ) {
            output = new FMatrixRMaj(input.numRows,1);
        } else {
            output.reshape(input.numRows,1);
     ...
     */
    public static FMatrixRMaj maxRows(FMatrixSparseCSC input ,   FMatrixRMaj output ,   IGrowArray gw) {
        if( output == null ) {
            output = new FMatrixRMaj(input.numRows,1);
        } else {
            output.reshape(input.numRows,1);
    ...
    public static float dotInnerColumns( FMatrixSparseCSC A , int colA , FMatrixSparseCSC B , int colB,
                                          IGrowArray gw , FGrowArray gx)
    {
        return ImplSparseSparseMult_FSCC.dotInnerColumns(A,colA,B,colB,gw,gx);
    }
                                ...
                                FMatrixRMaj x )
    {
        ...
        LinearSolverSparse<FMatrixSparseCSC,FMatrixRMaj> solver;
